...
/// - GET  /clubs/:clubId/instances/:type/:instanceId/members/insurance
  ...
  Future<List<MemberInsuranceModel>> getMembersInsurance({
    ...
    try {
      ...
      final response = await _dio.get(
        '$_baseUrl/clubs/$clubId/instances/$instanceType/$instanceId/members/insurance',
