...
///
/// [clubInstanceId] identifica el contexto de club activo.
class EvidenceFolderView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final folderAsync =
        ref.watch(evidenceFolderProvider(clubInstanceId));
    final c = context.sac;
      ...
      body: SafeArea(
        child: folderAsync.when(
          ...
          error: (error, _) => _ErrorBody(
            ...
            onRetry: () =>
                ref.invalidate(evidenceFolderProvider(clubInstanceId)),
          ),
