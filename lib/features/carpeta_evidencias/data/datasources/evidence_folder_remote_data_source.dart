...
abstract class EvidenceFolderRemoteDataSource {
  Future<EvidenceFolderModel> getEvidenceFolder(String clubInstanceId);

  Future<void> submitSection(String clubInstanceId, String sectionId);
...
class EvidenceFolderRemoteDataSourceImpl
  ...
  // ── GET /club-instances/:id/evidence-folder ─────────────────────────────────
  ...
  // ── POST /club-instances/:id/evidence-folder/sections/:sectionId/submit ─────
  ...
  // ── POST /club-instances/:id/evidence-folder/sections/:sectionId/files ──────
  ...
  // ── DELETE /club-instances/:id/evidence-folder/sections/:sectionId/files/:fileId
  ...
  Future<void> deleteFile({
    ...
    try {
      ...
      final response = await _dio.delete(
        '$_baseUrl/club-instances/$clubInstanceId/evidence-folder/sections/$sectionId/files/$fileId',
        options: _authOptions(token),
      );
