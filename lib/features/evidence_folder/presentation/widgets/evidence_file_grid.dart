...
///
/// - Imágenes: miniatura real con [Image.network].
/// - PDFs: ícono con nombre del archivo.
/// - Muestra quién subió el archivo y cuándo.
/// - [onDelete] visible sólo cuando [canDelete] es true.
class EvidenceFileGrid extends StatelessWidget {
  final List<EvidenceFile> files;
  final bool canDelete;
  final void Function(EvidenceFile file)? onDelete;

  const EvidenceFileGrid({
    super.key,
    required this.files,
