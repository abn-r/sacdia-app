...
/// Muestra el historial de transiciones de estado de un requerimiento.
///
/// Los datos disponibles son los snapshots de trazabilidad que trae la
/// entidad [ClassRequirement]: fecha/autor de envío y fecha/autor de
/// validación o rechazo. No existe un array de historial completo en el
/// backend — el modal refleja esto honestamente con un empty state cuando
/// el requisito sigue pendiente y aún no tiene eventos registrados.
///
/// Llamar con [showRequirementStatusHistorySheet].
class RequirementStatusHistorySheet extends StatelessWidget {
  ...
  /// disponibles en la entidad. El orden es cronológico: creación implícita
  /// → envío → validación/rechazo.
  List<_StatusEntry> _buildEntries() {
    ...
    // Si solo está pendiente (sin envío), no hay eventos adicionales →
    // se muestra únicamente la entrada de creación, lo cual ya es informativo.
    return entries;
  }
}
...
/// Abre el [RequirementStatusHistorySheet] como bottom sheet con el
/// look Apple/Cupertino pero usando el design system de la app.
void showRequirementStatusHistorySheet(
  ...
  showModalBottomSheet<void>(
    ...
    builder: (_) => RequirementStatusHistorySheet(requirement: requirement),
  );
}
