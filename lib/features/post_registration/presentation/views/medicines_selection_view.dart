...
class _MedicinesSelectionViewState
  ...
  Future<void> _showDeleteConfirmation(
    ...
    if (confirmed == true && context.mounted) {
      try {
        ...
        if (context.mounted) {
          SacSnackBar.show(
              context, 'post_registration.health.medicines.delete_success'.tr(),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: SacTopBar(
        title: 'post_registration.health.medicines.title'.tr(),
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isSelected ? m.mintSoft : m.paper,
        borderRadius: BorderRadius.circular(12),
        border: Border(
          left: isSelected
              ? BorderSide(color: m.mintFg, width: 3)
              : BorderSide.none,
        ),
      ),
      child: AnimatedSize(
