...
Future<void> showActivityMapOptions(
  ...
  return showModalBottomSheet<void>(
    ...
    builder: (_) => _ActivityMapOptionsSheet(activity: activity),
  );
}

class _ActivityMapOptionsSheet extends StatelessWidget {
  final Activity activity;

  const _ActivityMapOptionsSheet({required this.activity});

  bool get _hasCoordinates =>
      activity.lat != null && activity.longitude != null;

  String get _coordinateQuery => '${activity.lat},${activity.longitude}';

  String get _placeQuery {
    final place = activity.activityPlace.trim();
  ...
  Future<void> _launch(
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('activities.widgets.map_open_error'.tr()),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'activities.widgets.open_location_title'.tr(),
            style: Theme.of(context).textTheme.titleMedium?.copyWith(
                  fontWeight: FontWeight.w800,
                ),
          ),
          if (activity.activityPlace.trim().isNotEmpty) ...[
